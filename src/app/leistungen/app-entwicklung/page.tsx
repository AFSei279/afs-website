        ...
        <div className="container-page py-16 md:py-20">
          <div className="grid gap-10 md:grid-cols-[1fr_1.4fr] md:items-center">
            ...
            <div>
              ...
              <div className="mt-8">
                <Link
                  href="https://apps.apple.com/de/app/brettany/id6772245849"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 rounded-xl bg-black px-5 py-3 text-sm font-semibold text-white hover:bg-neutral-800 transition-colors"
                >
